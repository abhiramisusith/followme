...
class users(models.Model):
    ...
    MaritalStatus = models.CharField(db_column='MaritalStatus', max_length=20, blank=True, null=True)
    ...
    Contact = models.CharField(db_column='Contact', max_length=20, blank=True, null=True)
...
class Usersettings(models.Model):
    id = models.IntegerField(db_column='Id', primary_key=True)  # Field name made lowercase.
    rememberme = models.IntegerField(db_column='RememberMe', blank=True, null=True)  # Field name made lowercase.
